...
package com.simple.fwlibrary.log.xlog.internal;

import android.content.Intent;
import android.os.Bundle;

import com.simple.fwlibrary.log.xlog.flattener.DefaultFlattener;
import com.simple.fwlibrary.log.xlog.flattener.Flattener;
import com.simple.fwlibrary.log.xlog.formatter.border.BorderFormatter;
import com.simple.fwlibrary.log.xlog.formatter.border.DefaultBorderFormatter;
import com.simple.fwlibrary.log.xlog.formatter.message.json.DefaultJsonFormatter;
import com.simple.fwlibrary.log.xlog.formatter.message.json.JsonFormatter;
import com.simple.fwlibrary.log.xlog.formatter.message.object.BundleFormatter;
import com.simple.fwlibrary.log.xlog.formatter.message.object.IntentFormatter;
import com.simple.fwlibrary.log.xlog.formatter.message.object.ObjectFormatter;
import com.simple.fwlibrary.log.xlog.formatter.message.throwable.DefaultThrowableFormatter;
import com.simple.fwlibrary.log.xlog.formatter.message.throwable.ThrowableFormatter;
import com.simple.fwlibrary.log.xlog.formatter.message.xml.DefaultXmlFormatter;
import com.simple.fwlibrary.log.xlog.formatter.message.xml.XmlFormatter;
import com.simple.fwlibrary.log.xlog.formatter.stacktrace.DefaultStackTraceFormatter;
import com.simple.fwlibrary.log.xlog.formatter.stacktrace.StackTraceFormatter;
import com.simple.fwlibrary.log.xlog.formatter.thread.DefaultThreadFormatter;
import com.simple.fwlibrary.log.xlog.formatter.thread.ThreadFormatter;
import com.simple.fwlibrary.log.xlog.printer.Printer;
import com.simple.fwlibrary.log.xlog.printer.file.FilePrinter;
import com.simple.fwlibrary.log.xlog.printer.file.backup.BackupStrategy;
import com.simple.fwlibrary.log.xlog.printer.file.backup.FileSizeBackupStrategy;
import com.simple.fwlibrary.log.xlog.printer.file.naming.ChangelessFileNameGenerator;
import com.simple.fwlibrary.log.xlog.printer.file.naming.FileNameGenerator;
