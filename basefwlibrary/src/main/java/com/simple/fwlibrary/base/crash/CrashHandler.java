package com.simple.fwlibrary.base.crash;
...
/**
 * Created by envy15 on 2016/10/30.
 * 崩溃日志记录
 * 参考：
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            if (pi != null) {
                ...
                errInfo.put("versionName", versionName);
                errInfo.put("versionCode", versionCode);
            }
...
//        String fileName = "crash-" + System.currentTimeMillis() + ".log";
    ...
    public static String getGlobalPath() {
        return FwPathUtils.getCrashLogPath();
    }
