...
import com.simple.liteapps.base.http.base.BreakInfo;
import com.simple.liteapps.base.http.base.DLSPUtils;
import com.simple.liteapps.base.http.base.DLStringUtils;
...
public abstract class DLTaskImp extends Thread implements DLTaskInf {
    ...
    protected boolean getBreakInfo() {
        ...
        String pathKey = filePath.hashCode() + "";
